        ...
        content: [
          {
            type: 'list',
            items: [
              { lead: 'Формат:', text: 'экзамен состоит из двух частей — письменной и устной. Письменную часть можно не сдавать, если вы успешно закрыли бонус-тесты на курсах VWU.' },
              { lead: 'Продолжительность письменной части:', text: '3 часа.' },
        ...
        sub: [
          {
            h: 'Письменная часть',
            content: [
              { type: 'note', text: 'Важно: письменную часть можно закрыть без сдачи экзамена, если во время обучения на курсах VWU вы успешно закрыли бонус-тесты. Подробнее о бонус-тестах — здесь.' },
              { type: 'p', text: 'На письменную часть экзамена отводится 3 часа.' },
        ...
        content: [
          {
            type: 'list',
            items: [
              { lead: 'Формат:', text: 'экзамен состоит из двух частей — письменной и устной. Письменную часть можно не сдавать, если вы успешно закрыли 3 из 4 бонус-тестов на курсах VWU.' },
              { lead: 'Продолжительность письменной части:', text: '3 часа.' },
              { lead: 'Что можно использовать на экзамене:', text: 'разрешённых предметов нет.' },
              { lead: 'Регистрация:', text: 'необходимо зарегистрироваться на портале VWU.' },
            ],
        ...
        sub: [
          {
            h: 'Письменная часть',
            content: [
              { type: 'note', text: 'Важно: письменную часть можно закрыть без сдачи экзамена, если во время обучения на курсах VWU вы успешно закрыли 3 из 4 бонус-тестов. Подробнее о бонус-тестах — здесь.' },
              { type: 'p', text: 'На письменную часть экзамена отводится 3 часа.' },
